...
$getCate = "SELECT usr_acc.acc_id, stf_reg.stf_fname, stf_reg.stf_oname, stf_reg.stf_lname, usr_acc.stf_id_no, usr_acc.stf_mail, usr_acc.acc_stat, usr_cate.cate_displ_nm FROM usr_acc INNER JOIN stf_reg ON usr_acc.stf_reg_id = stf_reg.reg_id INNER JOIN usr_cate ON  usr_acc.usr_grp = usr_cate.usr_cate_id";
require "my_conn.php";
									...
									<table class="table table-hover table-responsive">
										...
										<tbody>
											...
											while($rw = $cat_rs->fetch_array()) {
												...
												$StfMail = $rw['stf_mail'];
												$AccStat = $rw['acc_stat'];
												$UsrCate = $rw['cate_displ_nm'];
												
												//Account Status
												if ($AccStat == 1){
													$AccStatTxt = "Active";
													$butTxt = "Deactivate User";
												}else{
													$AccStatTxt = "Inactive";
													$butTxt = "Activate";
												}
												...
												echo "<tr>";
												echo "<td>$Stf_fnm $Stf_onm $Stf_lnm</td>";
												echo "<td>$StfID</td>";
												echo "<td>$StfMail</td>";
												echo "<td>$AccStatTxt</td>";
												echo "<td>$UsrCate</td>";
												echo "<td>";
												?>
												  ...
												  <div class="modal-dialog  modal-lg">
													<div class="modal-content">
													  <div class="modal-header">
														<h5 class="modal-title" id="editCategoryLabel">Change User Category</h5>
												...
												<td><div class="form-check form-switch">
												  ...
												  <label class="form-check-label" for="flexSwitchCheckChecked"><?php echo $butTxt; ?></label>
												</div></td>
												<?php
												echo "</tr>";
											}
